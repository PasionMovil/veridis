...
vc_map( array(
    ...
    "params"	=> array(
        array(
            ...
            "holder" => "h3",
            "class" => "",
            "heading" => __("Foo attribute", "meganews"),
            "param_name" => "foo",
            "value" => __("I'm foo attribute", "meganews"),
            "description" => __("Enter foo value.", "meganews")
        ),
        array(
            "type" => "textarea_html",
            "holder" => "div",
            ...
            "param_name" => "content",
            "value" => __("I'm hello world", "meganews"),
            "description" => __("Enter your content.", "meganews")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Drop down example", "meganews"),
            "param_name" => "my_dropdown",
            "value" => array(1, 2, "three"),
            "description" => __("One, two or three?", "meganews")
        ),
    )
) );
