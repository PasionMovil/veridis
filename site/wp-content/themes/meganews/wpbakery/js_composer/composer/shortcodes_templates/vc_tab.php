...
$output .= "\n\t\t\t" . '<div id="tab-'. (empty($tab_id) ? sanitize_title( $title ) : $tab_id) .'" class="'.$css_class.' pero">';
$output .= ($content=='' || $content==' ') ? __("Empty section. Edit page to add content here.", "meganews") : "\n\t\t\t\t" . wpb_js_remove_wpautop($content);
