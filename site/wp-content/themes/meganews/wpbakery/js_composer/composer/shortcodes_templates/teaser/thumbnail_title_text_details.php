...
if ( $content ) {
	...
	$to_filter = '<div class="post-details"><div class="left"><div class="icon-post-format icon-'.$icon.'"></div><i>in</i> '.$cats.'</div></div>';
	$teasers .= apply_filters('vc_teaser_grid_details', $to_filter, array("grid_layout" => $grid_layout, "ID" => $post_id, "content" => $content, "media_link" => $p_link) );