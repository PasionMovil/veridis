...
extract(shortcode_atts(array(
    'title' => __("Click to toggle", "meganews"),
    'el_class' => '',
    'open' => 'false',
    'css_animation' => ''
), $atts));
...
$output .= apply_filters('wpb_toggle_heading', '<h4 class="'.$css_class.'"><div class="toggle-icon"></div>'.$title.'</h4>', array('title'=>$title, 'open'=>$open));
