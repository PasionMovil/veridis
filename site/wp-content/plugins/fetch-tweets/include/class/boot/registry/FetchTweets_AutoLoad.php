...
final class FetchTweets_AutoLoad {
	...
	protected function composeClassArray( $sClassDirPath, $aAllowedExtensions, $aRecursiveOptions ) {
		 ...
		 */
		protected function doRecursiveGlob( $sPathPatten, $nFlags=0, $asExcludeDirs=array() ) {
			...
			foreach ( $_aDirs as $_sDirPath ) {
				...
				$_aFiles = array_merge( $_aFiles, $this->doRecursiveGlob( $_sDirPath . DIRECTORY_SEPARATOR . basename( $sPathPatten ), $nFlags, $asExcludeDirs ) );
